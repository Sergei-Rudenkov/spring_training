 ...
 */
@Component
public class PriceCounterDao {
    static final String GET_OCCURRENCES = "select * from PRICE_COUNTER where name = ?";
    static final String SET_OCCURRENCES = "update PRICE_COUNTER set occurrences=? where name = ?";
    static final String INSERT = "insert into PRICE_COUNTER values(?, ?)";
    static final String GET_ALL = "select * from PRICE_COUNTER";
